mod abe {
  ...
  #[export_name = "encrypt"]
  unsafe extern "C" fn __wit_bindgen_encrypt(arg0: i32, arg1: i32, arg2: i32, arg3: i32, arg4: i32, arg5: i32, arg6: i32, arg7: i32, ) -> i32{
    let len0 = arg1 as usize;
    ...
    let result6 = <super::Abe as Abe>::encrypt(String::from_utf8(Vec::from_raw_parts(arg0 as *mut _, len0, len0)).unwrap(), Vec::from_raw_parts(arg2 as *mut _, len1, len1), result4, Vec::from_raw_parts(arg6 as *mut _, len5, len5));
    let (result9_0,result9_1,result9_2,) = match result6{
      Ok(e) => { {
  ...
  pub trait Abe {
    ...
    fn encrypt(plaintext: String,master_public_key: Vec<u8>,attributes: Vec<Attribute>,policy: Vec<u8>,) -> Result<Vec<u8>,String>;
